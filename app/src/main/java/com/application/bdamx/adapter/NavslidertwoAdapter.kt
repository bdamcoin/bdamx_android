...
class NavslidertwoAdapter (var activity: FragmentActivity, var type:Int, var menulist: MutableList<navigationModel>, @NonNull OnItemClickListener1:OnItemClickListener): RecyclerView.Adapter<NavslidertwoAdapter.viewHolder>() {
